  ...
  return (
    <div className="mt-3 border-t border-gray-700 pt-3">
      ...
      <div className="flex flex-col gap-1">
        {memberBets.map((m) => {
          const hasET = m.predictedETHome !== null && m.predictedETHome !== undefined;
          const hasTAB = m.predictedPenaltyWinner !== null && m.predictedPenaltyWinner !== undefined;
          const tabTeam = m.predictedPenaltyWinner === "home" ? homeTeam : awayTeam;
                  ...
                  <span className="text-right">
                    ...
                    {hasET && (
                      <span className="block text-xs text-gray-400 tabular-nums">
                        Prol. {m.predictedETHome} – {m.predictedETAway}
                        {hasTAB && tabTeam ? ` · TAB : ${tabTeam}` : ""}
                      </span>
                    )}
                  </span>
                ) : (
